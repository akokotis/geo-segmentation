...
######## Datasets ######
########################
total=nzQuery('SELECT * FROM DWADMIN.AK_GEO_PIVOT_total_visitors')
...
theme=nzQuery('SELECT * FROM DWADMIN.AK_GEO_PIVOT_nav_theme_counts')
...
filter=nzQuery('SELECT * FROM DWADMIN.AK_GEO_PIVOT_nav_filter_counts')
...
outlet=nzQuery('SELECT * FROM DWADMIN.AK_GEO_PIVOT_outlet_counts')
...
product=nzQuery('SELECT * FROM DWADMIN.AK_GEO_PIVOT_product_counts')
